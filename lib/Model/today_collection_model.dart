class TodayCollectionModel {
  ...
  set paidAmount(int? paidAmount) => _paidAmount = paidAmount;
  int? get dueAmount => _dueAmount;
  set dueAmount(int? dueAmount) => _dueAmount = dueAmount;
  int? get cash => _cash;
  set cash(int? cash) => _cash = cash;
  int? get online => _online;
  set online(int? online) => _online = online;
  ...
  set patient(List<Patient>? patient) => _patient = patient;

  TodayCollectionModel.fromJson(Map<String, dynamic> json) {
    _status = json['status'];
    _date = json['date'];
    ...
    if (json['patient'] != null) {
      ...
      json['patient'].forEach((v) {
        _patient!.add(new Patient.fromJson(v));
      });
    }
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this._patient != null) {
      data['patient'] = this._patient!.map((v) => v.toJson()).toList();
    }
    return data;
  }
}
