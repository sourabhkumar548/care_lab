class CaseModel {
  ...
  CaseModel({String? error, String? status, CaseData? caseData}) {
    if (error != null) {
      this._error = error;
    }
    if (status != null) {
  ...
  set caseData(CaseData? caseData) => _caseData = caseData;

  CaseModel.fromJson(Map<String, dynamic> json) {
    _error = json['error'];
    _status = json['status'];
    _caseData = json['CaseData'] != null
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this._caseData != null) {
      data['CaseData'] = this._caseData!.toJson();
    }
    return data;
  }
}
