class CaseListModel {
  String? _error;
  String? _status;
  List<CaseList>? _caseList;

  CaseListModel({String? error, String? status, List<CaseList>? caseList}) {
    if (error != null) {
      this._error = error;
    }
    if (status != null) {
  ...
  List<CaseList>? get caseList => _caseList;
  set caseList(List<CaseList>? caseList) => _caseList = caseList;
  ...
  CaseListModel.fromJson(Map<String, dynamic> json) {
    ...
    if (json['CaseList'] != null) {
      ...
      json['CaseList'].forEach((v) {
        _caseList!.add(new CaseList.fromJson(v));
      });
    }
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this._caseList != null) {
      data['CaseList'] = this._caseList!.map((v) => v.toJson()).toList();
    }
    return data;
  }
}
