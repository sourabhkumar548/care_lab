                  ...
                  children: [
                    ...
                    Row(children: [
                      ...
                      ElevatedButton(onPressed: (){
                        context.read<DoctorCollectionCubit>().getDoctorCollection(date: dateCtrl.text,month: Selectedmonth,year: Selectedyear,doctor: doctorCtrl.text);
                      }, child: UiHelper.CustText(text: "Search"))
                    ],),
