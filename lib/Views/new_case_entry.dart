...
import 'package:care_lab_software/Helpers/get_case_list.dart';
...
class _NewCaseEntryState extends State<NewCaseEntry> {
  ...
  TextEditingController onlineAdvanceCtrl = TextEditingController(text: "0");
                                        ...
                                        actions: <Widget>[
                                          ...
                                          ElevatedButton(
                                            ...
                                            onPressed: () {
                                              ...
                                              GetCaseList.showCaseDialog(context: context,
                                                  page: "case_entry",
                                                  case_no: caseNoCtrl.text,
                                                  case_date: dateCtrl.text,
                                                  case_time: timeCtrl.text,
                                                  ...
                                                  agent: agentCtrl.text,
                                                  doctor: doctorCtrl.text,
                                                  test_name: testNames.toString(),
                                                  test_rate: testRate.toString(),
                                                  total_amount: total.toString(),
                                                  discount: discountAmount.toString(),
                                                  after_discount: afterDiscount.toString(),
                                                  advance: advance.toString(),
                                                  balance: balance.toString(),
                                                  discount_type: discountTypeCtrl.text,
                                                  test_date: testDate.toString(),
                                                  test_file: state.testFile,
                                                  narration: narrationCtrl.text,
                                                  name_title: nametitleCtrl.text);
