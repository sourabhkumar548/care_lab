                  ...
                  return ListView.builder(
                    ...
                    return Container(
                      ...
                      child: ExpansionTile(title: Table(
                        ...
                        children: [
                          TableRow(children: [
                            Center(child: UiHelper.CustText(text: "${state.caseListModel.caseList![index].caseNo!}",size: 11.5.sp)),
                            UiHelper.CustText(text: "${state.caseListModel.caseList![index].patientName!}",size: 11.5.sp),
                            Center(child: UiHelper.CustText(text: "Mobile : ${state.caseListModel.caseList![index].mobile!}",size: 11.5.sp)),
                            Center(child: UiHelper.CustText(text: "Case Date : ${state.caseListModel.caseList![index].date}",size: 11.5.sp)),
                            Center(child: UiHelper.CustText(text: "Total Amt : ${state.caseListModel.caseList![index].afterDiscount!}",size: 11.5.sp)),
                            Center(child: UiHelper.CustText(text: "Status : ${state.caseListModel.caseList![index].balance! == "0" ? "Paid" : "Due"}",size: 11.5.sp)),
                          ...
                          ...state.caseListModel.caseList![index].items!.map((data){
                            ...
                            return Container(
                              ...
                              child: Table(
                                ...
                                children: [
                                  TableRow(children: [
                                          Center(child: UiHelper.CustText(text: "${data.slipNo}",size: 11.sp)),
                                          Center(child: UiHelper.CustText(text: "${data.date}",size: 11.sp)),
                                          Center(child: UiHelper.CustText(text: "${total.isEmpty ? "0" : total}",size: 11.sp)),
                                          Center(child: UiHelper.CustText(text: "${advance.isEmpty ? "0" : advance}",size: 11.sp)),
                                          Center(child: UiHelper.CustText(text: "${paid.isEmpty ? "0" : paid}",size: 11.sp)),
                                          Center(child: UiHelper.CustText(text: "${balance.isEmpty ? "0" : balance}",size: 11.sp)),
